...
SelectDirLabel3=Setup will install [name] into the following folder.%nImportant note: for successfull plugin work you must specify folder Plugins which is located near AIMP executable file.
...
BrowserScriptsDirSelectionMsg1=Select browser scripts directory
BrowserScriptsDirSelectionMsg2=Where should browser scripts be installed?
